            ...
            <form className='mt-20 border-solid border-inherit border-2 rounded-sm p-5 shadow-xl w-80' method="post" encType="multipart/form-data" >
                ...
                <div className='row'>
                    <div class="form-group col-md-12">
                        ...
                        <input type="password" class="form-control" placeholder="Enter password" onChange={e => setEmail(e.target.value)} />
                    </div>
                ...
                <button type="submit" class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 w-48">Cancel</button><br></br>
